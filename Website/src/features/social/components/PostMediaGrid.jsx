...
const PostMediaGrid = ({ mediaFileIds, onImageClick }) => {
  ...
  if (count === 1) {
    return (
      <div 
        className="w-full max-h-[500px] rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-800 flex items-center justify-center cursor-pointer hover:opacity-95 transition-opacity"
  ...
  if (count === 2) {
    return (
      <div className="grid grid-cols-2 gap-1 rounded-2xl overflow-hidden h-72 sm:h-[400px]">
        <div 
          className="w-full h-full bg-gray-100 dark:bg-gray-800 cursor-pointer hover:opacity-95 transition-opacity"
          onClick={() => onImageClick && onImageClick(0)}
        >
  ...
  if (count === 3) {
    return (
      <div className="grid grid-cols-2 grid-rows-2 gap-1 rounded-2xl overflow-hidden h-80 sm:h-[450px]">
        <div 
          className="w-full h-full bg-gray-100 dark:bg-gray-800 row-span-2 cursor-pointer hover:opacity-95 transition-opacity"
          onClick={() => onImageClick && onImageClick(0)}
        >
          <MediaImage fileId={mediaFileIds[0]} alt="Post media 1" className="w-full h-full object-cover" />
        </div>
  ...
  return (
    <div className="grid grid-cols-2 grid-rows-2 gap-1 rounded-2xl overflow-hidden h-80 sm:h-[450px]">
      ...
      <div 
        className="relative w-full h-full bg-gray-100 dark:bg-gray-800 group cursor-pointer"
