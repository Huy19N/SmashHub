              ...
              return (
                ...
                >
                  ...
                  <item.icon className={`absolute -right-3 -bottom-3 w-10 h-10 pointer-events-none transform rotate-12 transition-all duration-300 ${
                    isActive ? 'text-emerald-500/[0.08] dark:text-primary/[0.08] scale-110' : 'text-gray-400/[0.04] dark:text-gray-500/[0.04] group-hover/item:text-emerald-500/[0.06] group-hover/item:scale-105'
                  }`} />
