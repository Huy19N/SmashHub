      ...
      <aside className="hidden md:flex w-64 bg-white dark:bg-[#0d1117]/90 border-r border-gray-200 dark:border-border-dark flex-col justify-between h-screen sticky top-0 shrink-0 transition-colors duration-300">
            ...
            {sidebarItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-200 hover:translate-x-1.5 active:scale-95 font-label cursor-pointer relative overflow-hidden group ${isActive
        ...
        <div className="p-4 border-t border-gray-200 dark:border-border-dark/60 space-y-1 bg-gray-50/50 dark:bg-transparent">
          ...
          >
            ...
            <span className="text-[10px] px-2 py-0.5 rounded bg-gray-200/60 dark:bg-white/10 text-gray-600 dark:text-gray-400 relative z-10">
              {isDarkMode ? 'Tối' : 'Sáng'}
            </span>
          </button>
          ...
          <button 
            ...
            className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs font-semibold text-red-500 hover:bg-red-50 hover:text-red-700 dark:text-red-400 dark:hover:bg-red-500/10 dark:hover:text-red-300 transition-all font-label cursor-pointer disabled:opacity-50 relative overflow-hidden group"
          >
            <LogOut className="absolute -right-2 -bottom-2 w-8 h-8 text-red-500/[0.04] dark:text-red-400/[0.03] pointer-events-none transform rotate-12 group-hover:scale-110 transition-transform duration-300" />
