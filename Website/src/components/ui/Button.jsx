...
const Button = forwardRef(({
  ...
  const variants = {
    ...
    danger: "bg-red-600 hover:bg-red-700 text-white shadow-md shadow-red-650/20 hover:-translate-y-0.5"
  };
  ...
  return (
    ...
    >
      ...
      {(variant === 'primary' || variant === 'outline' || variant === 'secondary' || variant === 'danger') && (
