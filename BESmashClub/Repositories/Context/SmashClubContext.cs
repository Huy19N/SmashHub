...
public partial class SmashClubContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TeamInvite>(entity =>
        {
            ...
            entity.HasIndex(e => e.InviteToken, "UQ__TeamInvi__AB4795609B18FE11").IsUnique();
        ...
        modelBuilder.Entity<FacilityBankAccount>(entity =>
        {
            ...
            entity.HasOne(d => d.Facility).WithOne(p => p.BankAccount)
                .HasForeignKey<FacilityBankAccount>(d => d.FacilityId)
                .OnDelete(DeleteBehavior.ClientSetNull)
